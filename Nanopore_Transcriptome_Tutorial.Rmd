...
txdb <- makeTxDbFromGFF(file.path("/home/callum/transcriptome_tutorial/Analysis/ReferenceData", basename(config$annotation)))  # read Annotation field from config.yaml
